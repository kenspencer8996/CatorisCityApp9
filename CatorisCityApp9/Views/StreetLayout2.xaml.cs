...
public partial class StreetLayout2 : ContentView
{
	StreetLayoutController _controller;
    int badcount = 0;
    int tentx = 550;
    int tenty = 230;
    Image tentImage = new Image();
    string _toolbarsetting = string.Empty;
    public StreetLayout2()
	{
		InitializeComponent();
		_controller = new StreetLayoutController(this);
    ...
    private void BadGuy_MoveFromTent(object? sender, BadPersonMoveFiredEventArg e)
    {
        ...
        try
        {
            ...
            if (int.IsEvenInteger(GotoCampfire))
            {
                ...
                PersonViewModel badGuyWithPosition = e.Badguy;
                badGuyWithPosition.CampfireLocation = GetCanmpFireLocation(badguy.BadGuy.Name);
                if (badGuyWithPosition.CampfireLocation != null)
                {
                    ...
                    badGuyWithPosition.lastlocationX = badguyloc.X;
                    badGuyWithPosition.lastlocationY = badguyloc.Y;
    ...
    {
        BadPersonDroppedFiredEventArg arg = e;
        StopBadGuyandMovetoTent(arg.Badguy);
